/* Тернарная операция: сразу три операнда: если первое условие
 верно, то выполняется второе условие, если нет - третье*/
// int x=2;
// int y=3;
...
/*Пользователь вводит количество потребленных им углеводов,
белков и жиров. 
Посчитайте, сколько это калорий и каков % УБЖ из общего кол-ва*/
